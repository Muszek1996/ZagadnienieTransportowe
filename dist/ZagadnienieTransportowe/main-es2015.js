...
class Entity {
    constructor(index, cost = 0, name = 'O', entitiesService) {
...
class TransportConnection {
    constructor(supplier, recipient, cost = 0, entitiesService) {
...
TransportConnection.ctorParameters = () => [
...
let EntitiesService = class EntitiesService {
    ...
    addSupplier(cost = 0, name = 'Dostawca') {
        const supplier = new _Entities_entity__WEBPACK_IMPORTED_MODULE_3__["Entity"](this.suppliers.length, cost, name, this);
        ...
        if (!this.transportConnections[supplierIndex]) {
            ...
            this.recipients.forEach((r, rI) => {
                if (!this.transportConnections[supplierIndex][r.index]) {
                    ...
                    this.transportConnections[supplierIndex][r.index] = new _Entities_transport_connection__WEBPACK_IMPORTED_MODULE_2__["TransportConnection"](supplier, r, 0, this);
                }
            });
        }
        this.refreshConnections();
    ...
    addRecipient(cost = 0, name = 'Odbiorca') {
        const recipient = new _Entities_entity__WEBPACK_IMPORTED_MODULE_3__["Entity"](this.recipients.length, cost, name, this);
        const recipientIndex = recipient.index;
        this.recipients.push(recipient);
        this.suppliers.forEach(s => {
            if (!this.transportConnections[s.index][recipientIndex]) {
                this.transportConnections[s.index][recipientIndex] = new _Entities_transport_connection__WEBPACK_IMPORTED_MODULE_2__["TransportConnection"](s, recipient, 0, this);
            }
        });
        this.refreshConnections();
    }
...
let SolverService = class SolverService {
    constructor(entitiesService) {
        this.entitiesService = entitiesService;
    }
    count() {
      ...
      != ${this.entitiesService.getBaseVertexCount()}`);
            ...
            this.entitiesService.transportConnections.forEach((tCRow, tCRowI) => {
                tCRow.forEach((tC, tCI) => {
                    ...
                    if (tC.value === 0 || !isNaN(this.entitiesService.betas[tCI]) || isNaN(this.entitiesService.alfas[tCRowI])) {
                        return;
                    }
            ...
            this.entitiesService.betas.forEach((b, bI) => {
                this.entitiesService.transportConnections.forEach((tCRow, tCRowI) => {
                    if ((tCRow[bI].value === 0 && !tCRow[bI].isBase) || !isNaN(this.entitiesService.alfas[tCRowI])) {
                        return;
                    }
    ...
    degenerateProblemSolve() {
        ...
        nonBase.forEach(nB => {
            const graph = new _Entities_graph_graph__WEBPACK_IMPORTED_MODULE_3__["Graph"]();
...
module.exports = "table {\n  position: absolute;\n  border: 5px solid #476fbd;\n  border-radius: 10px;\n  border-spacing: 0px;\n  -webkit-transform: translate(-50%, -50%);\n  transform: translate(-50%, -50%);\n  top: 50%;\n  left: 50%;\n}\ntable > tr {\n  height: 70px;\n  vertical-align: center;\n}\ntable > tr > th {\n  height: 40px;\n}\ntable td, table th {\n  border: 3px solid #476fbd;\n  width: 200px;\n}\ntable i {\n  color: green;\n}\ntable div {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 100%;\n  height: 100%;\n  vertical-align: middle;\n}\ntable div button {\n  width: 100%;\n  height: 50%;\n  background: none;\n  border: none;\n}\ntable .addRecipientButtonsWrapper {\n  width: 15px;\n  margin-right: 5px;\n  display: flex;\n  flex-direction: column;\n}\ntable .addRecipientButtonsWrapper {\n  width: 20px;\n  float: right;\n}\ntable .recipientWrapper {\n  width: 80%;\n  height: 100px;\n  float: left;\n}\ntable .fa-plus {\n  color: green;\n}\ntable .fa-minus {\n  color: red;\n}\ntable th.background {\n  background: rgba(0, 255, 37, 0.4);\n  color: #302f32;\n}\ntable th.background.wrong {\n  background: rgba(255, 109, 31, 0.4);\n  color: #9c1523;\n}\n.reload {\n  position: fixed;\n  bottom: 30px;\n  right: 40px;\n  float: right;\n}\n.background {\n  width: 140px;\n  padding: 0;\n  margin: 0;\n}\n.line {\n  border-bottom: 1px solid red;\n  -webkit-transform: translateY(-44px) translateX(21px) rotate(25deg);\n          transform: translateY(-44px) translateX(21px) rotate(25deg);\n  position: absolute;\n  z-index: -1;\n}\n.background > div {\n  position: relative;\n  height: 100%;\n  width: 100%;\n  top: 0;\n  left: 0;\n}\n.bottom {\n  position: absolute;\n  bottom: 1px;\n  font-size: large;\n  left: 1px;\n}\n.top {\n  position: absolute;\n  font-size: large;\n  margin: 0px;\n  top: 1px;\n  right: 1px;\n}\n.baseVertex {\n  background: rgba(215, 81, 18, 0.45);\n}\n.licz {\n  position: fixed;\n  top: 5px;\n  right: 5px;\n  float: right;\n}\n.sbuttonsWrappertepButton {\n  position: fixed;\n  top: 5px;\n  left: 5px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
let TableComponent = class TableComponent {
    constructor(entitiesService, solver) {
        this.entitiesService = entitiesService;
        this.solver = solver;
